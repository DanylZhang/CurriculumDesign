...
namespace Danyl.SnnuURP.BLL
{
	...
	{
		private readonly Danyl.SnnuURP.DAL.WageInfo dal=new Danyl.SnnuURP.DAL.WageInfo();
		public WageInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Danyl.SnnuURP.Model.WageInfo GetModelByCache(int Id)
		{
			
			string CacheKey = "WageInfoModel-" + Id;
			...
			return (Danyl.SnnuURP.Model.WageInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Danyl.SnnuURP.Model.WageInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Danyl.SnnuURP.Model.WageInfo> DataTableToList(DataTable dt)
		{
			List<Danyl.SnnuURP.Model.WageInfo> modelList = new List<Danyl.SnnuURP.Model.WageInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Danyl.SnnuURP.Model.WageInfo model;
