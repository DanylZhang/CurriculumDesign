...
namespace Danyl.SnnuURP.BLL
{
    ...
    {
        private readonly Danyl.SnnuURP.DAL.RoomUseView dal = new Danyl.SnnuURP.DAL.RoomUseView();
        public RoomUseView()
        {}
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Danyl.SnnuURP.Model.RoomUseView GetModelByCache(int Id)
        {

            string CacheKey = "RoomUseViewModel-" + Id;
            ...
            return (Danyl.SnnuURP.Model.RoomUseView)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Danyl.SnnuURP.Model.RoomUseView> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Danyl.SnnuURP.Model.RoomUseView> DataTableToList(DataTable dt)
        {
            List<Danyl.SnnuURP.Model.RoomUseView> modelList = new List<Danyl.SnnuURP.Model.RoomUseView>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Danyl.SnnuURP.Model.RoomUseView model;
