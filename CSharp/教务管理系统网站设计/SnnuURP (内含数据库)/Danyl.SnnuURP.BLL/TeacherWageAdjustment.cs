...
{
    /// <summary>
    /// TeacherWageAdjustmentView
    /// </summary>
    public partial class TeacherWageAdjustmentView
    {
        private readonly Danyl.SnnuURP.DAL.TeacherWageAdjustmentView dal = new Danyl.SnnuURP.DAL.TeacherWageAdjustmentView();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Danyl.SnnuURP.Model.TeacherWageAdjustmentView GetModelByCache(int Id)
        {

            string CacheKey = "TeacherWageAdjustmentViewModel-" + Id;
            ...
            return (Danyl.SnnuURP.Model.TeacherWageAdjustmentView)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Danyl.SnnuURP.Model.TeacherWageAdjustmentView> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Danyl.SnnuURP.Model.TeacherWageAdjustmentView> DataTableToList(DataTable dt)
        {
            List<Danyl.SnnuURP.Model.TeacherWageAdjustmentView> modelList = new List<Danyl.SnnuURP.Model.TeacherWageAdjustmentView>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Danyl.SnnuURP.Model.TeacherWageAdjustmentView model;
