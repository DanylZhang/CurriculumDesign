...
namespace Danyl.SnnuURP.BLL
{
    ...
    {
        private readonly Danyl.SnnuURP.DAL.UserInfo dal = new Danyl.SnnuURP.DAL.UserInfo();
        public UserInfo()
        {}
        ...
        {
            return dal.DeleteList(Danyl.SnnuURP.Common.PageValidate.SafeLongFilter(Uidlist, 0));
        }
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Danyl.SnnuURP.Model.UserInfo GetModelByCache(int Uid)
        {
            ...
            return (Danyl.SnnuURP.Model.UserInfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Danyl.SnnuURP.Model.UserInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Danyl.SnnuURP.Model.UserInfo> DataTableToList(DataTable dt)
        {
            List<Danyl.SnnuURP.Model.UserInfo> modelList = new List<Danyl.SnnuURP.Model.UserInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Danyl.SnnuURP.Model.UserInfo model;
