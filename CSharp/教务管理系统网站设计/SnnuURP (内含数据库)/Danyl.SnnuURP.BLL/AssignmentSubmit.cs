...
namespace Danyl.SnnuURP.BLL
{
	...
	{
		private readonly Danyl.SnnuURP.DAL.AssignmentSubmit dal=new Danyl.SnnuURP.DAL.AssignmentSubmit();
		...
		{
			return dal.Exists(AssignmentId,Accessory,Id);
		}
		...
		public bool Delete(int AssignmentId,int Accessory,int Id)
		{
			...
			return dal.Delete(AssignmentId,Accessory,Id);
		}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Danyl.SnnuURP.Model.AssignmentSubmit GetModelByCache(int Id)
		{
			
			string CacheKey = "AssignmentSubmitModel-" + Id;
			...
			return (Danyl.SnnuURP.Model.AssignmentSubmit)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Danyl.SnnuURP.Model.AssignmentSubmit> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Danyl.SnnuURP.Model.AssignmentSubmit> DataTableToList(DataTable dt)
		{
			List<Danyl.SnnuURP.Model.AssignmentSubmit> modelList = new List<Danyl.SnnuURP.Model.AssignmentSubmit>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Danyl.SnnuURP.Model.AssignmentSubmit model;
